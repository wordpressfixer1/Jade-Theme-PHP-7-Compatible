...
// Register Module
function register_contentcarathree_module() {
    return dslc_register_module( "MET_ContentsCarousel3" );
}
add_action('dslc_hook_register_modules','register_contentcarathree_module');
