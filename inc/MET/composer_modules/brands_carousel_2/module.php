<?php
// Register Module
function register_brandscaratwo_module() {
    return dslc_register_module( "MET_BrandsCarousel2" );
}
add_action('dslc_hook_register_modules','register_brandscaratwo_module');
