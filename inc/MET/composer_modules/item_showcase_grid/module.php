<?php
// Register Module
function register_itemshowcasegrid_module() {
	return dslc_register_module( "MET_ItemShowcaseGrid" );
}
add_action('dslc_hook_register_modules','register_itemshowcasegrid_module');
