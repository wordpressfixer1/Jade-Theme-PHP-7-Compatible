...
// Register Module
function register_boxcaratesti_module() {
    return dslc_register_module( "MET_BoxCarouselTestimonials" );
}
add_action('dslc_hook_register_modules','register_boxcaratesti_module');
